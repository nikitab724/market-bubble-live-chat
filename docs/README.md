...
This directory is the repo's LLM-readable wiki. Use it before making non-trivial changes, then update it when the code or setup changes.
...
If a change affects behavior, setup, routes, connectors, deployment, tests, or data shape, update the matching doc in the same commit. Keep docs concise and avoid secrets.
